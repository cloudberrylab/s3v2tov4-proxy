...
import (
	...
	"github.com/minio/s3v2tov4-proxy/auth"
...
func main() {
	...
	listenAddr := flag.String("l", ":8000", "listen address (Signature-V2)")
	// Forwarding address.
	fwdAddr := flag.String("f", "http://localhost:9000", "forward address (Signature-V4)")
